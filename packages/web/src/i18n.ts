...
const en = {
  ...
  'radar.countFiltered': '{shown} / {total}',
  ...
  'radar.issuesFilteredEmpty': 'No issue matches the selected labels.',
  'radar.mrsFilteredEmptyFilter': 'No pull request matches the selected status filter.',
  'radar.mrsFilteredEmptyLabels': 'No pull request matches the selected labels.',
  'radar.mrsFilteredEmptyBoth': 'No pull request matches the selected status filter and labels.',
  'radar.clearFilters': 'Clear filters',
...
const fr: Record<MessageKey, string> = {
  ...
  'radar.issuesFilteredEmpty': 'Aucune issue ne correspond aux labels sélectionnés.',
  'radar.mrsFilteredEmptyFilter':
    'Aucune merge request ne correspond au filtre de statut sélectionné.',
  'radar.mrsFilteredEmptyLabels': 'Aucune merge request ne correspond aux labels sélectionnés.',
  'radar.mrsFilteredEmptyBoth':
    'Aucune merge request ne correspond au filtre de statut et aux labels sélectionnés.',
  'radar.clearFilters': 'Effacer les filtres',
