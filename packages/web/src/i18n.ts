...
const en = {
  ...
  // Not routed by any TaskEventType yet (TaskEventThinking.vue is built
  // ready to plug in), kept in this same block so the label already
  // exists in both catalogs the day a 'thinking' event type lands.
  'workspace.evThinking': 'Reasoning',
  ...
  // --- Changes panel: the merge-request side panel on a conversation ---
  'changes.noMr': 'No pull request linked to this conversation yet.',
  'changes.resizeAria': 'Resize the changes panel',
  'changes.close': 'Close the changes panel',
  'changes.copySourceBranch': 'Copy the source branch name',
  'changes.refresh': 'Refresh',
  'changes.openInForge': 'Open in the forge',
  'changes.tabs.files': 'Files changed',
  'changes.tabs.filesCount': 'Files changed · {n}',
  'changes.tabs.checks': 'Checks',
  'changes.tabs.checksFraction': '{passed}/{total}',
  'changes.checksTab.placeholder': 'Check details are not shown here yet.',
  'changes.file.statusAdded': 'Added',
  'changes.file.statusModified': 'Modified',
  'changes.file.statusDeleted': 'Deleted',
  'changes.file.statusRenamed': 'Renamed',
  'changes.file.deltaLabel': '{additions} additions, {deletions} deletions',
  'changes.fileList.loading': 'Loading the changed files…',
  'changes.fileList.loadError': 'Could not load the changed files.',
  'changes.fileList.retry': 'Retry',
  'changes.fileList.empty': 'No changed file.',
  'changes.fileList.summary': '{n} file changed | {n} files changed',
  'changes.fileList.diffLoading': 'Loading the diff…',
  ...
  'composer.hintTranscribing': 'Transcribing…',
  'composer.resizeHandleAria': 'Resize the input box',
  ...
  'rail.repositories': 'Repository',
  'rail.collapse': 'Collapse the menu',
  'rail.expand': 'Expand the menu',
  'rail.resizeAria': 'Resize the list column',
  'rail.repositoriesTitle': 'Repositories',
  'rail.repositoriesSearchPlaceholder': 'Search repositories…',
  'rail.repositoriesEmpty': 'No repository registered yet.',
  'rail.repositoriesSearchEmpty': 'No repository matches this search.',

  // --- Repository view: three tabs, four tiles, the branch table ---
  'repository.tabBranches': 'Branches',
  'repository.tabIssues': 'Issues',
  'repository.tabMrs': 'Merge requests',
  'repository.tileBranches': 'Branches',
  'repository.tileWorktrees': 'Worktrees',
  'repository.tileConversations': 'Conversations',
  'repository.tileNeedsYou': 'Needs you',
  'repository.filterPlaceholder': 'Filter branches…',
  'repository.sortLabel': 'Sort',
  'repository.sortStatus': 'Status',
  'repository.sortActivity': 'Activity',
  'repository.sortName': 'Name',
  'repository.refresh': 'Refresh',
  'repository.colWorktree': 'Worktree',
  'repository.colBranch': 'Branch',
  'repository.colMr': 'Merge request',
  'repository.colConversations': 'Conversations',
  'repository.colUpdated': 'Updated',
  'repository.colActions': 'Actions',
  'repository.worktreeLive': 'worktree',
  'repository.worktreeNone': 'no worktree',
  'repository.worktreeDetached': 'detached',
  'repository.branchCurrent': 'current',
  'repository.rowOpen': 'Open',
  'repository.rowNewConversation': 'New conversation',
  'repository.rowExpandAria': 'Show the conversations on {branch}',
  'repository.rowCollapseAria': 'Hide the conversations on {branch}',
  'repository.conversationsCount': '{n} conversation | {n} conversations',
  'repository.noBranches': 'This repository has no local branch.',
  'repository.filterEmpty': 'No branch matches this filter.',
  'repository.noConversationsOnBranch': 'No conversation on this branch yet.',
  ...
  'pilot.grid.empty': 'No conversation here yet. Launch one to follow it here.',
...
const fr: Record<MessageKey, string> = {
  ...
  'workspace.evMessage': 'Message',
  'workspace.evQuestion': 'Question',
  'workspace.evThinking': 'Réflexion',
  'workspace.evCommit': 'Commit',
  ...
  // --- Panneau de changements : le panneau latéral de merge request d'une conversation ---
  'changes.noMr': 'Aucune merge request liée à cette conversation pour le moment.',
  'changes.resizeAria': 'Redimensionner le panneau de changements',
  'changes.close': 'Fermer le panneau de changements',
  'changes.copySourceBranch': 'Copier le nom de la branche source',
  'changes.refresh': 'Rafraîchir',
  'changes.openInForge': 'Ouvrir dans la forge',
  'changes.tabs.files': 'Fichiers modifiés',
  'changes.tabs.filesCount': 'Fichiers modifiés · {n}',
  'changes.tabs.checks': 'Vérifications',
  'changes.tabs.checksFraction': '{passed}/{total}',
  'changes.checksTab.placeholder': "Le détail des vérifications n'est pas encore affiché ici.",
  'changes.file.statusAdded': 'Ajouté',
  'changes.file.statusModified': 'Modifié',
  'changes.file.statusDeleted': 'Supprimé',
  'changes.file.statusRenamed': 'Renommé',
  'changes.file.deltaLabel': '{additions} ajouts, {deletions} suppressions',
  'changes.fileList.loading': 'Chargement des fichiers modifiés…',
  'changes.fileList.loadError': 'Impossible de charger les fichiers modifiés.',
  'changes.fileList.retry': 'Réessayer',
  'changes.fileList.empty': 'Aucun fichier modifié.',
  'changes.fileList.summary': '{n} fichier modifié | {n} fichiers modifiés',
  'changes.fileList.diffLoading': 'Chargement du différentiel…',
  ...
  'composer.hintTranscribing': 'Transcription en cours…',
  'composer.resizeHandleAria': 'Redimensionner la zone de saisie',
  'composer.attachAria': 'Joindre',
  ...
  'rail.expand': 'Déplier le menu',
  'rail.resizeAria': 'Redimensionner la colonne de liste',
  'rail.repositoriesTitle': 'Dépôts',
  'rail.repositoriesSearchPlaceholder': 'Rechercher un dépôt…',
  ...
  'repository.tileWorktrees': 'Worktrees',
  'repository.tileConversations': 'Conversations',
  'repository.tileNeedsYou': 'Vous attendent',
  'repository.filterPlaceholder': 'Filtrer les branches…',
  'repository.sortLabel': 'Tri',
  'repository.sortStatus': 'État',
  'repository.sortActivity': 'Activité',
  'repository.sortName': 'Nom',
  'repository.refresh': 'Rafraîchir',
  'repository.colWorktree': 'Worktree',
  'repository.colBranch': 'Branche',
  'repository.colMr': 'Merge request',
  'repository.colConversations': 'Conversations',
  'repository.colUpdated': 'Mise à jour',
  'repository.colActions': 'Actions',
  'repository.worktreeLive': 'worktree',
  'repository.worktreeNone': 'pas de worktree',
  'repository.worktreeDetached': 'détachée',
  'repository.branchCurrent': 'courante',
  'repository.rowOpen': 'Ouvrir',
  'repository.rowNewConversation': 'Nouvelle conversation',
  'repository.rowExpandAria': 'Afficher les conversations sur {branch}',
  'repository.rowCollapseAria': 'Masquer les conversations sur {branch}',
  'repository.conversationsCount': '{n} conversation | {n} conversations',
  'repository.noBranches': 'Ce dépôt n’a aucune branche locale.',
  'repository.filterEmpty': 'Aucune branche ne correspond à ce filtre.',
  ...
  'pilot.grid.empty': 'Aucune conversation pour le moment. Lance-en une pour la suivre ici.',
