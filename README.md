...
| Key                         | File           | Effect                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| --------------------------- | -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `maxConcurrentAgents`       | global or repo | Machine-wide load cap (default **4**): the most agent turns, end-of-turn reviews and checks runs — confounded in one budget — this workspace runs at once, across every registered project. The workspace still runs at most one **active** task per repo (queued the rest in `<repo>/.codesema/queue.json`); this is the SECOND, cross-project cap on top of that.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `maxParallelTasks`          | global or repo | **Deprecated**, kept as an alias of `maxConcurrentAgents`: still read and honored, never silently dropped, but a boot that finds it set says so and names its replacement. When both keys are set, `maxConcurrentAgents` wins the value.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
